...
Bien cordialement,
Anthony Grimault
La Carte — Conseil · Analyse · Rentabilité · Tactique · Expertise`,
  },
  {
    ...
    <div class="lc-header">
      <div class="lc-logo">
        ...
        <div>
          ...
          <div class="lc-tagline">Conseil · Analyse · Rentabilité · Tactique · Expertise</div>
        </div>
      </div>
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:20px;">
      <div class="lc-logo">
        ...
        <div>
          ...
          <div class="lc-tagline" style="font-size:9px;">Conseil · Analyse · Rentabilité · Tactique · Expertise</div>
        </div>
      </div>
